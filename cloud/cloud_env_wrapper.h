...
class MockStorageProvider : public CloudStorageProvider {
 public:
  ...
  Status PutObjectMetadata(const std::string& /*bucket_name*/,
                           const std::string& /*object_path*/,
...
protected:
  Status DoNewCloudReadableFile(const std::string& /*bucket*/,
  ...
  Status DoPutObject(const std::string& /*local_path*/,
                     const std::string& /*bucket_name*/,
                     const std::string& /*object_path*/,
