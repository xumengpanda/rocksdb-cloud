...
unity_test: $(OBJ_DIR)/db/db_test.o $(TESTHARNESS) $(TOOL_OBJECTS) $(OBJ_DIR)/unity.a
	$(AM_LINK)
	./unity_test
...
db_blob_index_test: $(OBJ_DIR)/db/db_blob_index_test.o $(TEST_LIBRARY) $(LIBRARY)
	$(AM_LINK)
...
error_handler_test: $(OBJ_DIR)/db/error_handler_test.o $(TEST_LIBRARY) $(LIBRARY)
	$(AM_LINK)
...
block_cache_tracer_test: $(OBJ_DIR)/trace_replay/block_cache_tracer_test.o $(OBJ_DIR)/trace_replay/block_cache_tracer.o $(TEST_LIBRARY) $(LIBRARY)
	$(AM_LINK)
...
# A version of each $(LIB_OBJECTS) compiled with -fPIC
ifeq ($(HAVE_POWER8),1)
