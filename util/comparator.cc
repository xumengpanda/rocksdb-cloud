...
namespace rocksdb {
static const std::string kBytewiseComparator = "leveldb.BytewiseComparator";
static const std::string kReverseComparator =
...
class BytewiseComparatorImpl : public Comparator {
 public:
  ...
  const char* Name() const override { return kBytewiseComparator.c_str(); }
...
class ReverseBytewiseComparatorImpl : public BytewiseComparatorImpl {
 public:
  ...
  const char* Name() const override { return kReverseComparator.c_str(); }
...
static bool LoadComparator(const std::string& id, Comparator** result) {
  bool success = true;
  if (id == kBytewiseComparator) {
    *result = const_cast<Comparator*>(BytewiseComparator());
  } else if (id == kReverseComparator) {
...
Status Comparator::CreateFromString(const std::string& value,
  ...
  return LoadStaticObject<Comparator>(value, LoadComparator, opts, comparator);
}
